...
<div class="account-section ptb-80">
    ...
    <div class="account-area two">
        <div class="account-form-area text-center">
            ...
            <form action="{{ setRoute('invoice.payment.razor.callback') }}" method="GET">
                <script
                ...
                <input type="hidden" value="{{ setRoute('invoice.payment.razor.cancel',$orderId) }}" name="razorpay_cancel_url">
