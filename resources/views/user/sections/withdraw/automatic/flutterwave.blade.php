            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    ...
                    <div class="dash-payment-body">
                        <form class="card-form" action="{{ setRoute("user.withdraw.confirm.automatic") }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ number_format(@$moneyOutData->amount,2 )}} {{ getUserDefaultCurrencyCode() }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ __("1") }} {{ getUserDefaultCurrencyCode() }} =  {{ number_format(@$moneyOutData->gateway_rate,2 )}} {{ @$moneyOutData->gateway_currency }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                            ...
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--warning last">{{ number_format(@$moneyOutData->amount,2 )}} {{ getUserDefaultCurrencyCode() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
