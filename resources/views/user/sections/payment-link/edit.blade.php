                                        ...
                                        <div class="col-xl-12 form-group">
                                            <div class="preview-check-group">
                                                <div class="custom-check-group">
                                                    ...
                                                    <label for="level-2">{{ __('Securely save my information for 1-click checkout') }} <span>Pay faster on {{ Auth::user()->address->company_name ?? '' }} and everywhere Link is accepted</span></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-12 form-group">
                                        <div class="preview-check-group">
                                            <div class="custom-check-group">
                                                ...
                                                <label for="level-3">{{ __('Securely save my information for 1-click checkout') }} <span>Pay faster on {{ Auth::user()->address->company_name ?? '' }} and everywhere Link is accepted</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 form-group pt-10">
