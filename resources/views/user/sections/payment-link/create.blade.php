                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form--control link_title" name="title" placeholder="{{ __('Name of cause or service') }}" value="{{ old('title') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Description') }} <span>{{ __('optional') }}</span></label>
                                    <textarea class="form--control" name="details" placeholder="{{ __("Give customers more detail about what they're paying for.") }}" >{{ old('details') }}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="form-group">
                    ...
                    <div class="payment-product-form">
                        <div class="row">
                            <div class="col-xl-12 form-group">
                                <label>{{ __('Title') }}*</label>
                                <input type="text" class="form--control link_title" name="sub_title" placeholder="{{ __('Collecting Payment Platform') }}" value="{{ old('sub_title') }}">
                            </div>
                            <div class="col-12 form-group">
                                ...
                                <select class="select2-auto-tokenize currency_link_sub" name="sub_currency">
                                    <option value="" disabled selected>{{ __('Select One') }}</option>
                                    @foreach ($currency_data as $item)
                                            <option value="{{ $item->code }}" data-country="{{ $item->country }}" data-currency_name="{{ $item->name }}" data-code="{{ $item->code }}" data-currency_symbol="{{ $item->symbol }}">{{ $item->code. ' ('. $item->name.')' }}</option>
                                    @endforeach
                                </select>
                            </div>
