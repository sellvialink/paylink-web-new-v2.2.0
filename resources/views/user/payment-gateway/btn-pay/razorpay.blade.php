...
<body>
    ...
    <script>
        var options = {
            ...
            "amount": "{{ get_amount($output['charge_calculation']['requested_amount'], null, 2) * 100 }}", // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
