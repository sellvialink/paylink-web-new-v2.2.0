                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                ...
                                @endphp
                                <div class="chart" id="chart6" data-percent="{{ $percent_count ?? 0 }}"><span>{{ $percent_count ?? 0 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                ...
                                @endphp
                                <div class="chart" id="chart7" data-percent="{{ $percent_count ?? 0 }}"><span>{{ $percent_count ?? 0 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                ...
                                @endphp
                                <div class="chart" id="chart8" data-percent="{{ $percent_count ?? 0 }}"><span>{{ $percent_count ?? 0 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                ...
                                @endphp
                                <div class="chart" id="chart9" data-percent="{{ $percent_count ?? 0 }}"><span>{{ $percent_count ?? 0 }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
