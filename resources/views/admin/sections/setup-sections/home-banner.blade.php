                ...
                <div class="row justify-content-center mb-10-none">
                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => __('Secondary Button Name')."*",
                    ...
                    <div class="col-xl-12 col-lg-12 form-group">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Primary Button Link') }}*</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">{{ url('/') }}/</span>
                                        <input type="text" class="form--control" placeholder="{{ __('Button link') }}" name="primary_button_link" value="{{ old("primary_button_link",$data->value->primary_button_link ?? "") }}">
                                      </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Secondary Button Link') }}*</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">{{ url('/') }}/</span>
                                        <input type="text" class="form--control" placeholder="{{ __('Button link') }}" name="secondary_button_link" value="{{ old("secondary_button_link",$data->value->secondary_button_link ?? "") }}">
                                      </div>
                                </div>
                            </div>
                        </div>
