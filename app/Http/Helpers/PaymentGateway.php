...
class PaymentGateway {
    ...
    public function gateway() {
        ...
        }elseif($this->output['type'] == PaymentGatewayConst::TYPEPRODUCT){
            $data = ProductLink::with('user','product')->find($validated['target']);
            $this->output['product_link']       = $data;
        }else{
    ...
    public function chargeCalculate($currency) {
        ...
        if($this->output['type'] == PaymentGatewayConst::TYPEPAYLINK){
            ...
            $data = ProductLink::find($this->request_data[$this->target]);
