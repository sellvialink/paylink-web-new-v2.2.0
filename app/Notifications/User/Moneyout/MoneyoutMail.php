...
class MoneyoutMail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line("Request Amount: " . getAmount($data->amount,4).' '.$data->gateway_currency)
                    ->line("Exchange Rate: " ." 1 ".$data->gateway_currency.' = '. getAmount($data->gateway_rate,4).' '.$data->gateway_currency)
                    ...
                    ->line("Total Payable Amount: " . get_amount($data->payable,$data->gateway_currency,'4'))
                    ->line("Status: ". $status)
